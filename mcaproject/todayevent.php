...
<form action="todayevent.php" method="post">
 <input type="text" name="valueToSearch" placeholder="Value To Search"><br><br>
 <input type="submit" name="search" value="Search"><br><br>
 </form>
<table border = "4">
<caption>Today's  Event  List</caption>
<tr>
<th> E_NO </th>
<th> NAME_OF_EVENT </th>
<th> DATE </th>
...
if($total!=0)
{
	while($result = mysqli_fetch_assoc($data))
	{
		...
		{
			echo " <td><a href ='regis.html?Oen=$result[E_NO]&nm=$result[NAME_OF_EVENT]'>Paid Registration</td> ";
		}
