<html>
<head>
<link rel="stylesheet" href="vigyanmandir1.css">
<title> Vigyan Mandir </title>
</head>
<body>
...
<div class="navbar">
			...
			<nav>
				<ul>
					...
					<li><a href="vigyanrecords.php">REGISTRATION DATA</a></li>
				</ul>
			</nav>
		</div>
...
$date=date('Y/m/d');
$bh='journalism and mass communication';
